...
const QuestionBankDashboard = () => {
  ...
  }, [page, selectedQuestionType, selectedSpecialization, search, handleError]);
  ...
  const handleQuestionTypeChange = (e) => {
    ...
    setPage(1);
    // Fetch questions automatically when filter changes
    fetchQuestions();
  };
  ...
  const getSpecializationBadgeClass = (specialization) => {
    const classes = {
      [SPECIALIZATIONS.APTITUDE]: 'badge bg-primary-subtle text-primary',
      [SPECIALIZATIONS.VERBAL]: 'badge bg-info-subtle text-info',
          ...
          <div className="col-md-3">
            <div className="card bg-info text-white">
              <div className="card-body">
                <div className="d-flex justify-content-between align-items-center">
                  <div>
                    <h4 className="card-title mb-1">{stats.multiple_choice}</h4>
        ...
        <div className="card shadow-sm mb-4">
          <div className="card-body">
            <form onSubmit={handleSearchSubmit} className="row g-3">
              ...
              <div className="col-md-3">
                <label htmlFor="questionType" className="form-label">Question Format</label>
                <select
              ...
              <div className="col-md-3">
                ...
                <div className="form-text">
                  Filter by subject area/knowledge domain
                </div>
              </div>
          ...
          <div className="card-body p-0">
            {isLoading ? (
              ...
              <div className="text-center p-5">
                ...
                <Link to="/question-bank/create" className="btn btn-primary mt-2">
                  <i className="bi bi-plus-circle me-1"></i>
                  Create a Question
                </Link>
              </div>
