...
const QuestionBankCreateQuestion = () => {
  ...
  const validateForm = () => {
    ...
    if (filledOptions.length > 0) {
      // If options are provided, we need at least 2 options
      if (filledOptions.length < 2) {
        newErrors.options = 'Please provide at least 2 options for multiple choice questions';
      }
      
      // Need correct answer for multiple choice
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate(`/question-bank/${response.id}`);
    } catch (error) {
      handleError(error);
    } finally {
        ...
        <div className="row justify-content-center">
          <div className="col-lg-8">
            ...
            <div className="mb-4">
              ...
              <h1 className="h3 mb-0">Create New Question</h1>
              <p className="text-muted">Add a new question to your question bank</p>
            </div>
                  ...
                  <div className="mb-4">
                    <div className="d-flex justify-content-between align-items-center mb-3">
                      <label className="form-label mb-0">
                        Answer Options
                        <small className="text-muted ms-2">(Optional - leave blank for open-ended questions)</small>
                      </label>
                      <button
                        type="button"
